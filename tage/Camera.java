...
public class Camera
{
	...
	public void yawLeft(double frameRate){
		...
		setU(getU().rotateAxis((float) (1f*frameRate), getV().x(), getV().y(), getV().z()));
		setN(getN().rotateAxis((float) (1f*frameRate), getV().x(), getV().y(), getV().z()));
	...
	public void pitchUp(double frameRate){
		...
		setV(getV().rotateAxis((float) (1f*frameRate),getU().x(), getU().y(),getU().z()));
		setN(getN().rotateAxis((float) (1f*frameRate),getU().x(), getU().y(),getU().z()));
