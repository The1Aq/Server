...
public class GameObject
{
	...
	*/
	...
	public void yawLeft(double frameRate){
		Matrix4f newRotation;
		newRotation = new Matrix4f(getLocalRotation());
		newRotation.rotate((float) (1f*frameRate),0,1,0);
		setLocalRotation(newRotation);
	}

	public void yawRight(double frameRate){
		Matrix4f newRotation;
		newRotation = new Matrix4f(getLocalRotation());
		newRotation.rotate((float) (-1f*frameRate),0,1,0);
		setLocalRotation(newRotation);
	...
	public void pitchUp(double frameRate){
		Matrix4f newRotation;
		newRotation = new Matrix4f(getLocalRotation());
		newRotation.rotate((float) (-1f*frameRate),1,0,0);
		setLocalRotation(newRotation);
	}

	public void pitchDown(double frameRate){
		Matrix4f newRotation;
		newRotation = new Matrix4f(getLocalRotation());
		newRotation.rotate((float) (1f*frameRate),1,0,0);
		setLocalRotation(newRotation);
	...
	public float distanceTo(GameObject obj){
		...
		return this.getWorldLocation().distance(obj.getWorldLocation());

	}

	public float distanceTo(Camera c){

		return this.getWorldLocation().distance(c.getLocation());
